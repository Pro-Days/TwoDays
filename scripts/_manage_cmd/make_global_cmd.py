...
json_objects = {
    "랭킹": {
        ...
        "options": [
            ...
            {
                "name": "날짜",
                "description": "랭킹을 조회할 기준 날짜: YYYY-MM-DD, MM-DD, DD, -n (예시: 2025-12-31, 12-01, 05, -1, -20)",
                "type": 3,
                "required": False,
            },
            {
        ...
        "options": [
            {
                ...
                "options": [
                    ...
                    {
                        "name": "기간",
                        "description": "랭킹 히스토리를 조회할 기간: 2~ (예시: 2, 10, 123)",
                        "type": 4,
                        "required": False,
                        "min_value": 2,
                    },
                    {
                        "name": "날짜",
                        "description": "랭킹 히스토리를 조회할 기준 날짜: YYYY-MM-DD, MM-DD, DD, -1, ... (예시: 2025-12-31, 12-01, 05, -1, -20)",
                        "type": 3,
                        "required": False,
                    },
                    {
            ...
            },
            {
                ...
                "options": [
                    ...
                    {
                        "name": "기간",
                        "description": "레벨 히스토리를 조회할 기간: 2~ (예시: 2, 10, 123)",
                        "type": 4,
                        "required": False,
                        "min_value": 2,
                    },
                    {
                        "name": "날짜",
                        "description": "레벨 히스토리를 조회할 기준 날짜: YYYY-MM-DD, MM-DD, DD, -1, ... (예시: 2025-12-31, 12-01, 05, -1, -20)",
                        "type": 3,
                        "required": False,
                    },
                    {
    ...
    "유저분포": {
        ...
        "options": [
            {
                "name": "날짜",
                "description": "유저 레벨 분포를 조회할 기준 날짜: YYYY-MM-DD, MM-DD, DD, -n (예시: 2025-12-31, 12-01, 05, -1, -20)",
                "type": 3,
                "required": False,
            },
            {
